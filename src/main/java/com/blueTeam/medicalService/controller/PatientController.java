...
public class PatientController {
    ...
    @GetMapping("/{patientId}/medcard")
    public List<DoctorAppointmentRepresentationDto> getMedcard(@PathVariable Long patientId) {
        return doctorAppointmentService.getMedcard(patientId);
    }
}
